...
public abstract class BaseFileOptions(ImmutableArray<DirectoryInfo> Sources, DirectoryInfo Destination, Operation Operation, bool Overwrite, bool DryRun)
{
  public ImmutableArray<DirectoryInfo> Sources { get; init; } = Sources;
